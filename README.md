...
이 프로젝트는 여러 아르바이트를 병행하며 느꼈던 불편함에서 시작되었습니다. 매번 다른 시급과 근무 시간을 엑셀로 정리하고 계산하는 과정은 번거롭고 오류가 잦았습니다. '좀 더 쉽고 편하게 급여를 관리할 수 없을까?'라는 생각은 곧 '내가 직접 만들어보자!'는 결심으로 이어졌습니다.
